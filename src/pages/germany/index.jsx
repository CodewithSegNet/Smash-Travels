import backgroundImage from "../../assets/germanyhero.webp";
import backgroundImageMedium from "../../assets/germanyhero.webp";
import backgroundImageSmall from "../../assets/germanyhero.webp";
...
import JobGermany from "../../components/JobGermany";
...
const Germany = () => {
  return (
    <>
      <HelmetProvider>
        <Helmet>
          <title>Germany Jobs | Smash Travels</title>
          <meta
            name="description"
          ...
          <meta
            name="twitter:image"
            content="https://www.smashtravels.com/assets/germanyhero.webp"
          />
          <meta name="twitter:card" content="summary_large_image" />
          <link rel="canonical" href="https://www.smashtravels.com/job-germany" />
        </Helmet>
        ...
        <PackagePricing country={"Germany"} />
