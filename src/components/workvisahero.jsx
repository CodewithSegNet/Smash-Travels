        ...
        >
         ...
         <div className='hidden md:block'>
                  ...
                  className="flex items-center flex-row gap-3 mt-1">
                    <Link to="/"
                      className="flex items-center border-[1px] md:border-[1px] lg:border-[1px] bg-transparent justify-center text-md bg-opacity-100 hover:bg-opacity-50 border-white transition-all duration-300 py-2 px-4 md:py-2 md:px-6 lg:py-3 lg:px-6 text-white rounded-full  hover:bg-primary hover:text-white text-sm md:text-lg font-semibold"
                    >
                    ...
                    <Link
                      to="/work-visa"
                      className="flex items-center border-[3px]  lg:border-[3px] md:border-[3px] border-white bg-opacity-100 hover:bg-opacity-50 justify-center  bg-secondary  transition-all duration-300 text-white py-2 px-5 md:py-2 md:px-6 lg:px-6 lg:py-3 rounded-full  hover:bg-primary hover:text-white font-semibold text-sm md:text-lg"
                    >
