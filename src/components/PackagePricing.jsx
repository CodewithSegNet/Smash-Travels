...
const PackagePricing = ({ country }) => {
  ...
  return (
    ...
    <div className="max-w-screen-2xl mx-auto xl:mt-[150px] md:mt-[130px] mt-[95px] mb-[25px] lg:mb-[40px]">
      ...
      <div className="px-3 md:px-1 mx-auto w-[100%] md:w-[100%] lg:max-w-[100%] xl:min-w-[79%] xl:max-w-[60%] h-[150px] lg:h-[50px] my-2 shadow-md rounded-xl lg:rounded-full lg:text-[12px] text-[8px] flex flex-col lg:flex-row flex-nowrap justify-center items-center md:items-center text-newgray">
        <img src={notice} alt="" />
        <span className=" font-meutasBold text-primary text-[13px] md:text-[10px] md:pt-[4px] whitespace-nowrap">Please Note:</span>
        <span className="text-[11px] pl-2 md:font-medium md:text-[9.5px] text-regular xl:text-[9.5px] md:text-center lg:text-left">
