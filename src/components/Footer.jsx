  ...
  return (
    <div className=" md:max-w-screen-3xl mx-auto bg-[#393939] md:px-14 p-4 text-white">
        ...
        <div className='my-4 flex flex-col mx-auto md:flex-row gap-2'> 
            ...
            <div className='md:w-3/4 flex mx-auto  md:flex-row flex-col flex-wrap justify-between gap-3 mt-[2rem] items-start'>
            
            <div className='space-y-4'>
                    <h1 className=' text--300 font-black mb-8 md:text-xl'>Product</h1>
                ...
                <div className='space-y-4'>
                    <h1 className=' text--300 font-black md:text-xl'>Company</h1>
                    <ul className='space-y-3'>
                ...
                <div className='space-y-4'>
                    <h1 className=' text--300 font-black md:text-xl'>Resource</h1>
                    <ul className='space-y-3'>
                ...
                <div className='space-y-4'>
                    <h4 className='text--300 font-black md:text-xl'>Contact</h4>
                    <ul className='space-y-3'>
                ...
                <div className='space-y-4'>
                    <h1 className=' text--300 font-black md:text-xl'>Legal</h1>
                    <ul className='space-y-3'>
