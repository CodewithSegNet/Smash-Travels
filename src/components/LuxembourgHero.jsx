        ...
        <div className="w-[100%] flex flex-col md:mt-0 lg:mt-0 mt-3">
          ...
          <div className="block md:hidden">
            <motion.h1
              ...
              className="xl:text-7xl font-meutasBold md:text-4xl lg:text-6xl text-3xl text-white"
            >
              Relocate to Luxembourg Today With SmashTravels
            </motion.h1>
          </div>
          <motion.h3
            ...
            whileInView={"show"}
            viewport={{ once: true }}
            className="text-4xl sm:text- text-gray-100 pt-4 pb-6 md:pt-6 font-meutasRegular "
          >
