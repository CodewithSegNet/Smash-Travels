...
const BoardCard = () => {
  ...
  return (
    <motion.div
      ...
      whileInView={"show"}
      viewport={{ once: true }}
      className="relative bottom-[-30px] md:bottom-[-120px] text-regular font-meutasRegular max-w-screen-2xl mx-auto mb-8 w-[90%] rounded-[24px] md:min-h-[25rem] lg:min-h-[29rem] shadow-lg bg-white text-sm md:text-lg font-medium"
    >
      <div className="flex flex-wrap items-center w-[100%] lg:w-[70%] justify-between p-[2rem] md:p-[3rem]">
