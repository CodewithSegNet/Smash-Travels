...
const JobCanada = () => {
  ...
  return (
    ...
    <motion.div
      ...
      whileInView={"show"}
      viewport={{ once: true }}
      className="max-w-[1289px] text-regular mx-auto mt-[30px] md:mt-[50px] lg:mt-[80px] mb-[3rem] md:mb-[3rem] lg:mb-[2rem]"
    >
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 gap-12 lg:gap-8">
        {read.map((item, index) => {
          return (
            <div key={index}  className="flex text-regular md:pb-[2rem] justify-center items-center">
              <Cardd
                image={item.img}
